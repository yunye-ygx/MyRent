...
CREATE TABLE `house` (
  ...
  `city` varchar(32) NOT NULL DEFAULT '南京' COMMENT '城市',
  `region` varchar(32) NOT NULL DEFAULT '鼓楼区' COMMENT '区域',
  `near_subway` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否近地铁',
  `private_bathroom` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否独立卫浴',
  `has_balcony` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否带阳台',
  `civil_water_electric` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否民用水电',
  ...
  KEY `idx_house_city_region_status_price` (`city`,`region`,`status`,`price`),
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `house_hot_daily_stats`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
